...
FlatVarToFlatVar: TypeAlias = Callable[["FlatVar"], "FlatVar"]
PairVarToPairVar: TypeAlias = Callable[["PairVar"], "PairVar"]
...
RawFlatLinOpType: TypeAlias = FlatRawVarToFlatRawVar
RawPairLinOpType: TypeAlias = PairRawVarToPairRawVar
RawLinOpType: TypeAlias = RawFlatLinOpType | RawPairLinOpType
WrappedFlatLinOpType: TypeAlias = FlatVarToFlatVar
WrappedPairLinOpType: TypeAlias = PairVarToPairVar
WrappedLinOpType: TypeAlias = WrappedFlatLinOpType | WrappedPairLinOpType
LinOpType: TypeAlias = RawLinOpType | WrappedLinOpType
